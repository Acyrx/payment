          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
            <Card className="border-2 hover:border-blue-200 dark:hover:border-blue-800 transition-all duration-300">
              <CardHeader>
                ...
                <CardTitle className="text-lg">VS Code Interface</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Familiar VS Code-inspired interface with syntax highlighting,
                  code completion, and a professional development experience.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 hover:border-blue-200 dark:hover:border-blue-800 transition-all duration-300">
              <CardHeader>
                <div className="w-12 h-12 rounded-lg bg-indigo-100 dark:bg-indigo-950 flex items-center justify-center mb-3">
                  <GraduationCap className="w-6 h-6 text-indigo-600 dark:text-indigo-400" />
                </div>
                <CardTitle className="text-lg">AI-Powered Tutoring</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Get instant help from AI tutors who understand your code,
                  explain concepts, and guide you through challenges.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 hover:border-blue-200 dark:hover:border-blue-800 transition-all duration-300">
              <CardHeader>
                <div className="w-12 h-12 rounded-lg bg-violet-100 dark:bg-violet-950 flex items-center justify-center mb-3">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Follow structured paths from beginner to advanced with
                  interactive lessons, quizzes, and coding challenges.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 hover:border-blue-200 dark:hover:border-blue-800 transition-all duration-300">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Code hands-free with voice commands for formatting, debugging,
                  and code generation.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 hover:border-blue-200 dark:hover:border-blue-800 transition-all duration-300">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Chat with AI about your code, ask questions, and get
            ...
            <Card className="border-2 hover:border-blue-200 dark:hover:border-blue-800 transition-all duration-300">
              <CardHeader>
                <div className="w-12 h-12 rounded-lg bg-cyan-100 dark:bg-cyan-950 flex items-center justify-center mb-3">
                  <BookOpen className="w-6 h-6 text-cyan-600 dark:text-cyan-400" />
                </div>
                <CardTitle className="text-lg">Code Library</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Save and organize your code snippets, access them anytime, and
